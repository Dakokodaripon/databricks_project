...
CREATE TABLE dbacademy_david_akokodaripon_take_net_dewd_2_1.student
...
CREATE TABLE IF NOT EXISTS dbacademy_david_akokodaripon_take_net_dewd_2_1.student 
  (id INT, name STRING, value DOUBLE)
...
INSERT INTO dbacademy_david_akokodaripon_take_net_dewd_2_1.student VALUES (1, "Yve", 1.0);
INSERT INTO dbacademy_david_akokodaripon_take_net_dewd_2_1.student VALUES (2, "Omar", 2.5);
INSERT INTO dbacademy_david_akokodaripon_take_net_dewd_2_1.student VALUES (3, "Elia", 3.3);
...
INSERT INTO dbacademy_david_akokodaripon_take_net_dewd_2_1.student
VALUES 
  (4, "Ted", 4.7),
  (5, "Tiffany", 5.5),
  (6, "Vini", 6.3)
...
SELECT * FROM dbacademy_david_akokodaripon_take_net_dewd_2_1.student
...
UPDATE dbacademy_david_akokodaripon_take_net_dewd_2_1.student 
SET value = value + 1
WHERE name LIKE "T%"
...
DELETE FROM dbacademy_david_akokodaripon_take_net_dewd_2_1.student
WHERE value > 6
...
MERGE INTO dbacademy_david_akokodaripon_take_net_dewd_2_1.student b
USING updates u
ON b.id=u.id
